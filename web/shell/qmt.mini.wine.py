...
g.configFile = "c:\\qmt.config.json"
...
def getDeals():
    ...
    result = xt_trader.export_data(
        stockAccount, "c:\\guojin_deal.csv", "deal", start_time="2025-01-01", end_time="2025-05-11")
    info(result)
...
def log2File(toPrint, file="z:\\data\\logs\\qmt.mini", sep=' ', end='\n', flush=True, mode='a', encoding='utf-8'):
    """
...
if __name__ == '__main__':
    ...
    path = r'Z:\data\soft\gjzqqmt\userdata_mini'
    #获取环境变量proxy的值
